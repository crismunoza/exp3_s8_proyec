                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/RecordComponent.html" data-type="entity-link" >RecordComponent</a>
                            </li>
                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            <li class="link">
                                <a href="classes/FirestoreMock.html" data-type="entity-link" >FirestoreMock</a>
                            </li>
                            <li class="link">
                                <a href="classes/MockAuth.html" data-type="entity-link" >MockAuth</a>
                            </li>
                            <li class="link">
